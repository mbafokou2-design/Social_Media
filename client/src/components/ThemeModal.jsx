...
const ThemeModal = () => {
    ...
    const closeThemeModal = e => {
        if (e.target.classList.contains("theme")) {  // ✅ fixed typo
            dispatch(uiSliceActions.closeThemeModal())  // ✅ added ()
        }
    }
        ...
        <section className='theme' onClick={e => closeThemeModal(e)}>
            <div className='theme__container'>
                ...
                <article className="theme__background">
                    ...
                    <ul>
                        <li onClick={() => changeBackgroundColor("")}></li>       {/* ✅ fixed */}
                        <li onClick={() => changeBackgroundColor("dark")}></li>   {/* ✅ fixed */}
                    </ul>
                </article>
            </div>
        </section>
